...
use MCPEVN\SetVip;
 ...
 class Main extends PluginBase {
  ...
  public $prefix = "§a[ §bDream Block-§bNapThe§a ]";
  public $cfg;
  public $tien;
  public $cap;
  public $rank;
   ...
   if($this->tien->exists($result["amount"])) {
	...
	fclose($fh);
     ...
     return true;
       ...
       $s->sendMessage("§a- thẻ nạp thành công nhưng mệnh giá thẻ không có trong danh sách thẻ nên không nhận được đồng xu nào, xin hãy chụp màn hình và gửi cho Nguyễn Quang Trí trên facebook");
       if($result["amount"]=='10000'){
			$loai_card ="10k";
		}
	   else if($result["amount"]=='20000'){
	...
	fclose($fh);
      ...
      $s->sendMessage($this->prefix."§a• §acách dùng:  §d/napthe [coin, vip] ");
     }
   break;
...
date_default_timezone_set('Asia/Ho_Chi_Minh');
	...
	fclose($fh);
     return true;
       ...
       $s->sendMessage("§e• §a thẻ nạp thành công nhưng mệnh giá thẻ không có trong danh sách thẻ nên không nhận được đồng xu nào, xin hãy chụp màn hình và gửi cho Nguyễn Quang Trí trên facebook");
       if($result["amount"]=='10000'){
			$loai_card ="10k";
		}
	   else if($result["amount"]=='20000'){
	...
	fclose($fh);
     return true;
      ...
      $s->sendMessage($this->prefix."§a• §acách dùng:  §dIB Facebook Nguyễn Quang Trí");
     }
   break;
   }
 } else {
